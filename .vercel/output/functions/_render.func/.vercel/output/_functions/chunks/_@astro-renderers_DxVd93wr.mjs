import { useCssVars, useSlots, ref, onMounted, toRefs, computed, watch, watchEffect, openBlock, createElementBlock, normalizeStyle, unref, createElementVNode, withKeys, renderSlot, createVNode, Transition, withCtx, withDirectives, createTextVNode, toDisplayString, createBlock, createCommentVNode, vShow, onBeforeUnmount, reactive, nextTick, isRef, defineComponent, h, createSSRApp } from 'vue';
import Vue3Toasity from 'vue3-toastify';
import { renderToString } from 'vue/server-renderer';
import { j as AstroUserError, A as AstroError } from './astro/assets-service_d1YwEJAr.mjs';
import { A as AstroJSX, i as renderJSX, e as createVNode$1 } from './astro/server_Dx38DLQz.mjs';
...
async function renderToStaticMarkup(Component, props = {}, { default: children = null, ...slotted } = {}) {
  ...
  const { result } = this;
  try {
    const html = await renderJSX(result, createVNode$1(Component, { ...props, ...slots, children }));
    return { html };
  } catch (e) {
    throwEnhancedErrorIfMdxComponent(e, Component);
    throw e;
...
export { entry_esm as e, renderers as r };
