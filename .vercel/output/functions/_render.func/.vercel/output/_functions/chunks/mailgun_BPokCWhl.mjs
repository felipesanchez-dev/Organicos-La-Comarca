...
let {
  ...
  FROM_EMAIL_ADDRESS,
  TO_EMAIL_ADDRESS
} = Object.assign({"BASE_URL": "/", "MODE": "production", "DEV": false, "PROD": true, "SSR": true, "SITE": "https://starfunnel.unfolding.io", "ASSETS_PREFIX": undefined}, { MAILGUN_API_KEY: "xxx", MAILGUN_DOMAIN: "website.io", MAILGUN_API_URL: "https://api.eu.mailgun.net", FROM_EMAIL_ADDRESS: "hello@website.io", TO_EMAIL_ADDRESS: "hello@website.io", OS: process.env.OS });
const POST = async ({ site, params, request }) => {
  if (!MAILGUN_API_KEY || !FROM_EMAIL_ADDRESS || !TO_EMAIL_ADDRESS || !MAILGUN_API_URL)
